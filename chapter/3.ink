...
=jq_biwu
    *[远处有几位武师]
    你来到几位武师面前双手抱拳说道：“听庄主说各位都是庄内的好手，特来此领教各位壮士的高招”
    ...
    *[来吧]
    ...
    眼看来不及作出反应，你此时
        ...
        *[多谢壮士]
        你获得一包伤药
        天色已晚，这场比试消耗了你不少的体力，你觉得十分劳累，回厢房去休息一下吧。 #CLASS:red,bold
        ->dh_swt
//地图导航
=dh_swt
    +[往南走 · 柳秀山庄正厅]
...
=dh_xxf
    -(action)
    *(eat_shangyao){jq_biwu}[服用伤药] 
    你服用了伤药，感觉身上的伤没那么痛了，或许再休息一阵子就能痊愈了
    ->dh_xxf
    +[休息]
    ->gn_xiuxi
    +[往北走 · 男浴室] 
...
=gn_xiuxi
    ...
    +[起床]
    {
    - not jq_after_shoushang && eat_shangyao:
        ->jq_after_shoushang
    }
    ->dh_xxf
